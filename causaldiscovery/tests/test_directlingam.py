...
from vcausal.causaldiscovery.fcm.lingam.directlingam import DirectLiNGAMAlgorithm


class DirectLingamAlgorithmTestCase(unittest.TestCase):
    ...
    def test_DL(self):
        ...
        X = pd.DataFrame(np.array([x0, x1, x2, x3, x4, x5]).T, columns=['x0', 'x1', 'x2', 'x3', 'x4', 'x5'])
         ...
         # Create an instance of the DirectLiNGAMAlgorithm class
        dl = DirectLiNGAMAlgorithm(X)
