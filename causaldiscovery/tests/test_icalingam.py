...
from vcausal.causaldiscovery.fcm.lingam.icalingam import IcaLiNGAMAlgorithm


class ICALingamAlgorithmTestCase(unittest.TestCase):
    ...
    def test_DL(self):
        ...
        X = pd.DataFrame(np.array([x0, x1, x2, x3, x4, x5]).T, columns=['x0', 'x1', 'x2', 'x3', 'x4', 'x5'])
         ...
         # Create an instance of the IcaLiNGAMAlgorithm class
        ica = IcaLiNGAMAlgorithm(X)
